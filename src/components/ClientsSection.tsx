...
export default function ClientsSection() {
  return (
    <section className="py-24 bg-gradient-to-br from-gray-50 via-white to-gray-100 relative overflow-hidden">
      ...
      <EnhancedBackgroundAnimation intensity="subtle" theme="organic" />
        ...
        >
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden relative">
            ...
            <div className="relative z-10 p-12">
              {/* Quote icon */}
              <motion.div 
                className="absolute top-8 left-8 text-6xl text-[var(--brand-primary)]/30 font-serif"
                animate={{
                  opacity: [0.3, 0.6, 0.3],
                  scale: [1, 1.1, 1],
                }}
              ...
              <motion.blockquote 
                className="text-xl md:text-2xl text-gray-700 italic leading-relaxed mb-8 relative z-10"
                animate={{
                  opacity: [0.9, 1, 0.9],
                }}
                transition={{
