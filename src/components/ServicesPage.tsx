      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            <Button variant="outline" className="group relative px-8 py-4 border-2 border-[var(--brand-primary)]/50 text-[var(--brand-primary)] rounded-xl font-semibold hover:bg-[var(--brand-primary)]/10 transition-all duration-500 hover:scale-105 hover:-translate-y-1 backdrop-blur-sm bg-white/90 shadow-lg hover:shadow-xl overflow-visible">
              <span className="relative z-10 flex items-center">
        ...
        <div className="grid lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
          {advantages.map((advantage, index) => (
            <motion.div
              ...
              className="group relative"
            >
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-10 shadow-xl border border-gray-200/50 relative overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-4 h-[300px] flex flex-col justify-between">
                {/* Hover background effect */}
                ...
                {/* Icon */}
                <motion.div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${advantage.color} p-4 mb-6 mx-auto relative z-10 shadow-lg group-hover:shadow-xl`}
                  whileHover={{ 
                    scale: 1.15,
                    rotate: [0, -10, 10, 0],
                  }}
                ...
                <div className="text-center relative z-10">
                  <h3 className={`text-2xl font-bold mb-4 transition-all duration-300 bg-gradient-to-r ${advantage.color} bg-clip-text text-transparent group-hover:scale-105`}>
                    {advantage.title}
                  </h3>
