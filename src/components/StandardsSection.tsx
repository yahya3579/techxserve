    ...
    <section className="py-24 bg-gradient-to-br from-gray-50 via-white to-gray-100 text-gray-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10" ref={ref}>
        ...
        >
          ...
          >
            <motion.span
              className="absolute -inset-3 bg-gradient-to-r from-[var(--brand-primary)]/20 via-purple-500/15 to-blue-500/20 rounded-full blur-sm"
              animate={{
                scale: [1, 1.4, 1],
                opacity: [0.3, 0.7, 0.3],
              }}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <Card className="bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-2xl border border-gray-200 hover:border-[var(--brand-primary)]/30 transition-all duration-700 transform hover:-translate-y-4 group-hover:scale-105 relative overflow-hidden">
                {/* Gradient overlay */}
                <motion.div
