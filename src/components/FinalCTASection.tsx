...
export default function FinalCTASection() {
  return (
    <section className="py-24 bg-gradient-to-br from-[var(--brand-primary)] via-[var(--brand-primary-light)] to-[var(--brand-primary-dark)] text-white relative overflow-hidden">
      ...
      <EnhancedBackgroundAnimation intensity="high" theme="mixed" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            <Button
              size="lg"
              className="bg-white text-[var(--brand-primary)] hover:bg-gray-100 px-8 py-4 text-lg rounded-full font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-2xl group"
            >
              Start Your Journey
              <motion.div
                className="ml-2"
