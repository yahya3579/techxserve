              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-gray-200/50 relative overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-4">
                ...
                <div className="relative z-10">
                  <div className="flex items-center mb-4">
                    <motion.div
                      className={`w-12 h-12 rounded-xl bg-gradient-to-br ${product.color} p-3 mr-4 shadow-lg group-hover:shadow-xl`}
                      whileHover={{ 
                        scale: 1.1,
                        rotate: [0, -5, 5, 0],
                      }}
                    ...
                    <div>
                      <h3 className={`text-2xl font-bold bg-gradient-to-r ${product.color} bg-clip-text text-transparent group-hover:scale-105 transition-all duration-300`}>
                        {product.name}
                      </h3>
