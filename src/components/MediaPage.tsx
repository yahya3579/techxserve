      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              {[
                { icon: Mail, label: "media@techxserve.com", type: "email" },
                { icon: Phone, label: "+1 (555) 123-4567", type: "phone" },
                { icon: MapPin, label: "Creative District, New York", type: "location" },
              ].map((contact, index) => (
                <motion.div
                  key={contact.type}
          ...
          >
            <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 relative overflow-hidden">
              ...
              <form className="space-y-6 relative z-10">
                ...
                <motion.button
                  type="submit"
                  className="w-full px-8 py-4 bg-gradient-to-r from-purple-600 to-cyan-600 text-white font-semibold rounded-xl relative overflow-hidden group"
                  whileHover={{ 
                    scale: 1.02,
                    boxShadow: '0 0 40px rgba(168, 85, 247, 0.8)'
                  }}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center space-y-8">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            © 2025 TechxServe Media. The other side of creativity.
          </motion.p>
        </div>
      </div>
    </footer>
